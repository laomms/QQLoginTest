...
#region Jce解码
		...
		public static int DecodeSimpleList(ref byte[] bytesIn, int tag, int jceDatalen)
		{
			...
			if ((QQ_Login.JceStruct.JceType)jceData[0] == JceType.TYPE_STRUCT_BEGIN || (QQ_Login.JceStruct.JceType)jceData[0] == JceType.TYPE_LIST || (QQ_Login.JceStruct.JceType)jceData[0] == JceType.TYPE_SIMPLE_LIST || (QQ_Login.JceStruct.JceType)jceData[0] == JceType.TYPE_MAP && Convert.ToInt32(jceData[1]) == 0)
			{
				var tempBytes = bytesIn;
