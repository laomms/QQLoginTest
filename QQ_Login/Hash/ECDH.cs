...
namespace QQ_Login
{
	public class ECDH
	{
		public static Data.ECDH_Struct GetECDHKeys()
		{
			Data.ECDH_Struct ECDH = new Data.ECDH_Struct();
			byte[] PrivateKey = new byte[1024];
			byte[] PublicKey = new byte[1024];
			byte[] Sharekey = new byte[16];
			byte[] SvrPubKey = Data.HexStrToByteArray("04EBCA94D733E399B2DB96EACDD3F69A8BB0F74224E2B44E3357812211D2E62EFBC91BB553098E25E33A799ADC7F76FEB208DA7C6522CDB0719A305180CC54A82E");
			...
			ECDH.Sharekey = Data.MD5Hash(Sharekey);
			return ECDH;
		}
		public static Data.ECDH_Struct GetECDHKeys2()
		{
			Data.ECDH_Struct ECDH = new Data.ECDH_Struct();
			byte[] Sharekey = new byte[16];
